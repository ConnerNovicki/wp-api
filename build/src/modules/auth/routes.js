...
router.post("/register", (0, validate_1.validate)(register_1.registerUserSchema), register_1.registerUserHandler);
router.post("/login", (0, validate_1.validate)(login_1.loginUserSchema), login_1.loginUserHandler);
